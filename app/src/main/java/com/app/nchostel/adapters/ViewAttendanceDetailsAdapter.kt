...
class ViewAttendanceDetailsAdapter(private val context: Activity, private val mList: List<AttendanceModel>) : RecyclerView.Adapter<ViewAttendanceDetailsAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.attendance_row_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val ItemsViewModel = mList[position]
         holder.user_id_tv!!.text = ItemsViewModel.name
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra("user_id",mList.get(position).user_id)
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        ...
        val user_id_tv: TextView = itemView.findViewById(R.id.user_id_tv)
